...
export default class MineralPath {
	...
	makeDefaultPath() {
		...
		//step 2 path 1 0
		this.start.getNext(1).getNext(0).setNext(new Node([">20% Quartz, ", "<10% Mafic minerals,", "K-feldspar (Orthoclase) > ", "Plagioclase"], "Other properties", true, -1))
			.setNext(new Node([" >20% Quartz, ", ">10% Mafic minerals, ", " K-feldspar (Orthoclase) < ", "Plagioclase"], "Other properties", true, -1))
			.setNext(new Node(["0-20% Quartz, ", "Feldspars dominate, ", "K-feldspar (Orthoclase) > ", "Plagioclase, some Hornblende ", "possible "], "Other properties", true, -1))
			.setNext(new Node(["0-20% Quartz, ", "Feldspars dominate, ", "K-feldspar (Orthoclase) < ", "Plagioclase, some Augite ", "possible"], "Other properties", true, -1))
			.setNext(new Node(["0-5% Quartz, ", "Mafic minerals and ", "Na-rich (light-colored) ", "Plagioclase dominate, ", "Hornblende and Biotite common"], "Other properties", true, -1))
			.setNext(new Node(["0-5% Quartz, ", "Mafic minerals and ", "Ca-rich (dark-colored) ", "Plagioclase dominate, ", "Augite common, some Olivine ", "possible"], "Other properties", true, -1))
			.setNext(new Node(["90-100% Mafics, ", "0-5% Feldspars, ", "Mix of Augite and Hornblende, ", "some Olivine"], "Other properties", true, -1))
			.setNext(new Node(["90-100% Mafics, ", "0-5% Feldspars, ", "Olivine dominates, black Chromite ", "minerals possible"], "Other properties", true, -1));

		//step 2 path 1 1
		this.start.getNext(1).getNext(1).setNext(new Node([">20% Quartz, ", "<10% Mafic minerals,", "K-feldspar (Orthoclase) > ", "Plagioclase"], "Other properties", true, -1))
			.setNext(new Node([" >20% Quartz, ", ">10% Mafic minerals, ", " K-feldspar (Orthoclase) < ", "Plagioclase"], "Other properties", true, -1))
			.setNext(new Node(["0-20% Quartz, ", "Feldspars dominate, ", "K-feldspar (Orthoclase) > ", "Plagioclase, some Hornblende ", "possible "], "Other properties", true, -1))
			.setNext(new Node(["0-20% Quartz, ", "Feldspars dominate, ", "K-feldspar (Orthoclase) < ", "Plagioclase, some Augite ", "possible"], "Other properties", true, -1))
			.setNext(new Node(["0-5% Quartz, ", "Mafic minerals and ", "Na-rich (light-colored) ", "Plagioclase dominate, ", "Hornblende and Biotite common"], "Other properties", true, -1))
		...
		//step 2 path 1 2
		this.start.getNext(1).getNext(2).setNext(new Node([">20% Quartz, ", "<10% Mafic minerals,", "K-feldspar (Orthoclase) > ", "Plagioclase"], "Other properties", true, -1))
			.setNext(new Node([" >20% Quartz, ", ">10% Mafic minerals, ", " K-feldspar (Orthoclase) < ", "Plagioclase"], "Other properties", true, -1))
			.setNext(new Node(["0-20% Quartz, ", "Feldspars dominate, ", "K-feldspar (Orthoclase) > ", "Plagioclase, some Hornblende ", "possible "], "Other properties", true, -1))
			.setNext(new Node(["0-20% Quartz, ", "Feldspars dominate, ", "K-feldspar (Orthoclase) < ", "Plagioclase, some Augite ", "possible"], "Other properties", true, -1))
			.setNext(new Node(["0-5% Quartz, ", "Mafic minerals and ", "Na-rich (light-colored) ", "Plagioclase dominate, ", "Hornblende and Biotite common"], "Other properties", true, -1))
